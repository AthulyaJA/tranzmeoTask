...
const ProductValidation = Yup.object().shape({
    ...
    product_name: Yup.string().required("Field is required").nullable(),
...
export default function Dashboard() {
    ...
    const handleSubmit = (values: any, actions: any) => {
        SendProduct(values, actions)
    }

    const SendProduct = (values: any, actions: any) => {
                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="sidebarCollapse">
                        ...
                        <ul className="navbar-nav">
                            ...
                            <li className="nav-item">
                                <a className="nav-link" href="#">
                                    <i className="bi bi-people"></i> Products
                                </a>
                            </li>
                        </ul>
                                ...
                                <div className="col-sm-6 col-12 text-sm-end">
                                    <div className="mx-n1">
                                        ...
                                        <a href="#" className="btn d-inline-flex btn-sm btn-primary mx-1">
                                            ...
                                            <span onClick={() => { setIsShowing(true) }}>Create product</span>
                            ...
                            <div className="col-xl-3 col-sm-6 col-12">
                                <div className="card shadow border-0">
                                    <div className="card-body">
                                        <div className="row">
                                            <div className="col">
                                                <span className="h6 font-semibold text-muted text-sm d-block mb-2">Total Product</span>
                                    ...
                                    <tbody>
                                        ...
                                        {data?.map((item: any) => {
                                            ...
                                            return (<>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img alt="..." src={item?.images[0] ? item?.images[0] : item?.images[1]} className="avatar avatar-sm rounded-circle me-2" />
                                                    ...
                                                    <td>
                                                        <span className="badge badge-lg badge-dot">
                                                            <i className="bg-success"></i> {item?.stock
                                                            }
                                                        </span>
                                                    </td>
